...
public class CmdBallIntake extends CommandBase {
    ...
    public CmdBallIntake(NAR_Drivetrain drive, Limelight ballLimelight) {
        ...
        switch (aimState) {
            ...
            case FEEDBACK:
                if (!ballLimelight.hasValidTarget()) {
                    ...
                    m_drivetrain.arcadeDrive(powerMult * VisionConstants.BALL_VISION_kF, powerMult * feedbackPower);
            ...
            case BLIND:
                ...
                m_drivetrain.tankDrive(0.35, 0.35); // move forwards
